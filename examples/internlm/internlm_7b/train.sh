...
export GPU_NUMS=8
# srun -p $PARTITION -N $(expr $GPU_NUMS / 8) -n $GPU_NUMS --ntasks-per-node=8 --gpus-per-task=1
# torchrun --nnodes=1 --nproc_per_node=8 ./examples/internlm/internlm_7b/train.py --config ./examples/internlm/internlm_7b/config.py
