...
torchrun --nnodes=1 --nproc_per_node=16 --master_port=22502 ./examples/internlm/internlm2_7b/train.py --config ./examples/internlm/internlm2_7b/config.py --launcher "torch"
